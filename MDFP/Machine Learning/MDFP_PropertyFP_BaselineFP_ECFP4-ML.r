...
for (seed in 2^seq(1,10)){
	...
	# lassoFit  <- train(pIC50 ~ ., data = MDFP_train_lasso, 
								...
								# tuneGrid = lassoGrid,
								# trControl = fitControl2)
	plsGrid <- expand.grid(ncomp  = seq(1, min(ncol(MDFP_train)-1, nrow(MDFP_train)*0.8-2)))
	set.seed(seed)
	...
	plot_scatter(pred=svmFit_pred, obs=MDFP_test$pIC50, FP="MDFP_PropertyFP_BaselineFP_ECFP4", ML=paste0("SVM", "_seed", seed))
	...
	plot_scatter(pred=gbmFit_pred, obs=MDFP_test$pIC50, FP="MDFP_PropertyFP_BaselineFP_ECFP4", ML=paste0("GBM", "_seed", seed))
	...
	plot_scatter(pred=rfFit_pred, obs=MDFP_test$pIC50, FP="MDFP_PropertyFP_BaselineFP_ECFP4", paste0("RF", "_seed", seed))
	...
	plot_scatter(pred=plsFit_pred, obs=MDFP_test$pIC50, FP="MDFP_PropertyFP_BaselineFP_ECFP4", ML=paste0("PLS", "_seed", seed))
	...
	plot_scatter(pred=consensus_pred, obs=MDFP_test$pIC50, FP="MDFP_PropertyFP_BaselineFP_ECFP4", ML=paste0("consensus", "_seed", seed))
...
write.csv(metric_cv_all, file="MDFP_PropertyFP_BaselineFP_ECFP4_metric_cv_all.csv")
write.csv(metric_test_all, file="MDFP_PropertyFP_BaselineFP_ECFP4_metric_test_all.csv")

write.csv(metric_cv_all_summary, file="MDFP_PropertyFP_BaselineFP_ECFP4_metric_cv_all_summary.csv")
write.csv(metric_test_all_summary, file="MDFP_PropertyFP_BaselineFP_ECFP4_metric_test_all_summary.csv")

save.image("MDFP_PropertyFP_BaselineFP_ECFP4-ML.rData")
